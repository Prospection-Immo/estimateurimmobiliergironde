-- SCRIPT SQL CORRIGÉ - TYPES D'ID COHÉRENTS
-- Toutes les tables utilisent VARCHAR (pas UUID) pour maintenir la cohérence
...
-- Guide Downloads (CORRIGÉ: guide_id en VARCHAR pour correspondre à guides.id)
...
-- Lead Scoring (CORRIGÉ: lead_id en VARCHAR pour correspondre à leads.id)
...
-- Lead Score History (CORRIGÉ: lead_id en VARCHAR)
...
SELECT 
  ...
  'Types d''ID cohérents: VARCHAR avec gen_random_uuid()' as note;