-- SCRIPT CORRIGÉ AVEC LES VRAIS NOMS DE COLONNES
-- Correspond exactement au schéma Drizzle
...
-- 3. SMS TEMPLATES (avec les bons noms de colonnes)
...
-- 4. SCORING CONFIG (avec les bons noms de colonnes)
...
SELECT 
  'DONNÉES DE BASE SYNCHRONISÉES AVEC SUCCÈS!' as message,
