        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              ...
              <Link href="/guides" className="block text-sm text-muted-foreground hover:text-primary hover-elevate px-2 py-1 rounded" data-testid="link-footer-guide">
                Guides vendeurs
              </Link>
        ...
        <div className="border-t border-border mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <nav className="flex space-x-6">
              ...
              <Link href="/gironde-login" className="text-sm text-muted-foreground hover:text-primary hover-elevate px-2 py-1 rounded" data-testid="link-footer-admin" aria-label="Admin">
